...
int main()
{
    ...
    while (!valid_email) {
      ...
      if (at_index == 0) {
        cout << "There must be at least one character before the @.\n";
        valid_email = false;
      }

      // make sure there is at least one character before the dot character
      if (dot_index - at_index <= 1) {
        cout << "There must be at least one character between the @ and dot.\n";
        valid_email = false;
      }
      ...
      if (length_of_domain < 2 || length_of_domain > 3) {
        cout << "There must be two or three characters after the dot character.\n";
        valid_email = false;
      }
