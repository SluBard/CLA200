...
namespace validation {
	...
	bool is_valid_email(string email) {
          ...
          if (at_index == 0) {
            cout << "The local part of the email must include at least one "
                    "character.\n";
            valid_email = false;
          }
          ...
          if (dot_index - at_index == 1) {
            cout << "The server name of the email must include at least one "
                    "character.\n";
            valid_email = false;
          }

          // make sure the domain name has two or three characters
          if (email.length() - dot_index - 1 != 3 &&
              email.length() - dot_index - 1 != 2) {
            cout << "The domain name of the email must have two or three "
                    "characters.\n";
            valid_email = false;
          }
          return valid_email;
