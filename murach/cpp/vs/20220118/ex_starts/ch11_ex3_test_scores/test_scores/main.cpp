...
int main()
{
    ...
    if (scores.empty()) {                 // vector is empty
        ...
        //int m = 90;
        //int counti = count_if(scores.begin(), scores.end(), MinScore(m));
        //cout << "Scores " << m << " or above: " << counti << endl;
        //m = 80;
        //counti = count_if(scores.begin(), scores.end(), MinScore(m));
        //cout << "Scores " << m << " or above: " << counti << endl;

        int m = 90;
        auto MinScore = [&m](int i)->bool {return i >= m;  };
        int counti = count_if(scores.begin(), scores.end(), MinScore);
        cout << "Scores " << m << " or above: " << counti << endl;
        m = 80;
        counti = count_if(scores.begin(), scores.end(), MinScore);
        cout << "Scores " << m << " or above: " << counti << endl;
