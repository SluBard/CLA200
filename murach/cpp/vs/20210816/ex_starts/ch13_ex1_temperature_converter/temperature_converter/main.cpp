...
double to_celsius(double fahrenheit) {
    if (fahrenheit < 32 || fahrenheit > 212) {
        throw invalid_argument("Error! Fahrenheit value must be between 32 and 212 degrees.\n");
    }
...
double to_fahrenheit(double celsius) {
    if (celsius < 0 || celsius > 100) {
        throw invalid_argument("Error! Celsius value must be between 0 and 100 degrees.\n");
    }
